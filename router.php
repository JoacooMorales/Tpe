        ...
        switch ($params[0]) {
            case 'listar':
                ...
                $albumes = $albumController->getAlbumes();
                $controller = new CancionController();
                $controller->showCanciones($albumes);
                break;
            case 'agregar':
                $controller = new CancionController();
            ...
            case 'editarCancion':
                ...
                $albumController = new AlbumController();
                $albumes=$albumController->getAlbumes();
                $controller->editarCancion($params[1],$albumes);
                break;

            case 'filtroCanciones':
                $controller = new CancionController();
                $controller->mostrarCancionesPorID($params[1]);
                break;

            case 'actualizarCancion':
                $controller = new CancionController();
                $controller->actualizarCancion($params[1]);
                break;
